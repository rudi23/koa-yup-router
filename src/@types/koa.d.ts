...
declare module 'koa' {
    ...
    import type { IncomingMessage, ServerResponse, Server, IncomingHttpHeaders, OutgoingHttpHeaders } from 'http';
    import type { Http2ServerRequest, Http2ServerResponse } from 'http2';
    import type { Socket, ListenOptions } from 'net';
    import type * as url from 'url';
    import type { ParsedUrlQuery } from 'querystring';
    import type * as accepts from 'accepts';
    import type * as Cookies from 'cookies';
    import httpAssert = require('http-assert');
    import type * as HttpErrors from 'http-errors';
    import type * as Keygrip from 'keygrip';
    import type * as compose from 'koa-compose';
    import type * as contentDisposition from 'content-disposition';

    declare interface ContextDelegatedRequest<QueryT = ParsedUrlQuery, HeadersT = IncomingHttpHeaders> {
        /**
    ...
    > extends EventEmitter {
         ...
         */
        use<NewStateT = Record<string, any>, NewContextT = Record<string, any>>(
    ...
    declare namespace Application {
        ...
        type DefaultContextExtends = Record<string, any>;
        /**
        ...
        type Middleware<
            ...
            RequestT = Request<QueryT, HeadersT>
        > = compose.Middleware<ParameterizedContext<StateT, ContextT, ResponseBodyT, QueryT, HeadersT, RequestT>>;

        interface BaseRequest<QueryT = ParsedUrlQuery, HeadersT = IncomingHttpHeaders>
            extends ContextDelegatedRequest<QueryT, HeadersT> {
            /**
        ...
        interface BaseContext<QueryT = ParsedUrlQuery, HeadersT = IncomingHttpHeaders>
            extends ContextDelegatedRequest<QueryT, HeadersT>,
             ...
             */
            throw(message: string, code?: number, properties?: Record<string, any>): never;
            throw(status: number): never;
            throw(...properties: Array<number | string | Record<string, any>>): never;
        ...
        interface Request<QueryT = ParsedUrlQuery, HeadersT = IncomingHttpHeaders>
            extends BaseRequest<QueryT, HeadersT> {
            app: Application;
            req: IncomingMessage;
            res: ServerResponse;
            ctx: Context;
        ...
        interface ExtendableContext<QueryT = ParsedUrlQuery, HeadersT = IncomingHttpHeaders>
            extends BaseContext<QueryT, HeadersT> {
            app: Application;
            request: Request;
            response: Response;
            req: IncomingMessage;
        ...
        type ParameterizedContext<
            ...
            QueryT = ParsedUrlQuery,
            HeadersT = IncomingHttpHeaders,
            RequestT = Record<string, any>
        > = ExtendableContext<QueryT, HeadersT> & { state: StateT } & {
            request: Request<QueryT, HeadersT> & RequestT;
        } & ContextT & {
                body: ResponseBodyT;
                response: { body: ResponseBodyT; request: Request<QueryT, HeadersT> & RequestT };
            };
